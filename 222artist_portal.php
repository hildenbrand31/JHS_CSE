 ...
 * 
 * 222artist_portal.php allows users with artist accounts to upload images and modify data 
	...
	isset($_SERVER['PHP_AUTH_PW']) )
{
	...
	elseif (mysql_num_rows($result))
	{
		...
		if ($password == $row[1])
		{
			...
			echo '<form action="222artist_portal.php" method="post" enctype="multipart/form-data"><pre>';
			...
			if ($_FILES)
			{
				...
				if ($name != '')
				{
					...
					move_uploaded_file($_FILES['filename']['tmp_name'], $username . "/" . $name);
					...
					echo "Uploaded image '$username/$name'<br /><img src='$thumbname' />";
